  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        constellationEnter: 'constellationEnter 0.8s cubic-bezier(0.25, 0.1, 0.25, 1.5) forwards',
        constellationPathExit: 'constellationPathExit 0.6s ease-out forwards',
        subtleImageDrift: 'subtleImageDrift var(--drift-duration, 20s) linear infinite alternate',
