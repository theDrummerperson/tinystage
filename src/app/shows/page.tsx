    ...
    <main className='overflow-hidden relative'>
          ...
          <div className='max-w-4xl mx-auto space-y-8 mb-12'>
            ...
            <div className='border-l-2 border-brand-yellow pl-6 ml-4 max-w-2xl mx-auto motion-safe:animate-fadeIn' style={{ animationDelay: '0.7s' }}>
              <p className='text-xl md:text-2xl text-brand-gray-light italic'>
                Intimate performances, unforgettable moments. This is where local talent takes the spotlight.
              </p>
            </div>
          </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid md:grid-cols-5 gap-12 items-center'>
            <div className='md:col-span-2 text-center md:text-left motion-safe:animate-fadeIn' style={{ animationDelay: '0.2s' }}>
              ...
              <h2 className='text-3xl sm:text-4xl font-bold mb-3 text-brand-white'>Catch Us Live</h2>
              <p className='text-xl text-brand-gray-medium'>The next show is just around the corner.</p>
            </div>
            <div className='md:col-span-3 motion-safe:animate-fadeIn' style={{ animationDelay: '0.4s' }}>
              <p className='text-lg md:text-xl text-brand-gray-light leading-relaxed mb-6'>
                Our stage is a living, breathing part of Erie's music scene. We regularly feature incredible artists in intimate settings, creating an experience you won't forget.
              </p>
              ...
              <Link
                href='/calendar' // Corrected link to the calendar page
      ...
      <section className='relative py-20 md:py-28 bg-brand-black z-[1] overflow-hidden'>
        ...
        <div className='container mx-auto px-4 text-center relative z-[1]'>
          <div className='max-w-3xl mx-auto mb-20 md:mb-24 motion-safe:animate-fadeIn' style={{ animationDelay: '0.1s' }}>
            <h2 className='text-3xl sm:text-4xl font-bold mb-4 text-brand-white'>From the Archive</h2>
            <p className='text-lg md:text-xl text-brand-gray-light max-w-2xl mx-auto'>Relive the moments that defined our stage. Here are a couple of standout performances from our past shows.</p>
          </div>
          <div className='relative flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-0 max-w-5xl mx-auto mb-16 min-h-[500px] md:min-h-[400px]'>
            <div className='w-full max-w-md md:absolute md:left-0 md:top-0 group motion-safe:animate-fadeIn' style={{ animationDelay: '0.3s' }}>
              <Link href='/artist/deja-blue' className='block relative aspect-video lg:aspect-[4/3] rounded-lg overflow-hidden shadow-2xl transition-all duration-500 ease-out md:rotate-[-4deg] md:hover:rotate-0 md:hover:scale-105 md:hover:z-10 hover:shadow-[0_0_45px_rgba(var(--brand-yellow-rgb),0.3)]'>
                ...
                <div className='absolute inset-0 bg-brand-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center'>
                  <Play className='h-16 w-16 text-brand-white drop-shadow-lg transform scale-75 group-hover:scale-100 transition-transform duration-300' fill='currentColor' />
                </div>
                <div className='absolute bottom-0 left-0 p-6 w-full text-left'>
                  <h3 className='text-3xl font-bold text-brand-yellow drop-shadow-md transition-transform duration-300 group-hover:translate-x-1'>Deja Blue</h3>
                  <p className='mt-2 text-brand-gray-light max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-out delay-75'>Electrifying, soulful vocals, songwriting, and raw, emotion-infused guitar and drums. This is Deja Blue!</p>
                </div>
              </Link>
            </div>
            <div className='w-full max-w-md md:absolute md:right-0 md:bottom-0 group motion-safe:animate-fadeIn' style={{ animationDelay: '0.5s' }}>
              <Link href='/rartist/johnny-kocur' className='block relative aspect-video lg:aspect-[4/3] rounded-lg overflow-hidden shadow-2xl transition-all duration-500 ease-out md:rotate-[3deg] md:hover:rotate-0 md:hover:scale-105 md:hover:z-10 hover:shadow-[0_0_45px_rgba(var(--brand-yellow-rgb),0.3)]'>
                ...
                <div className='absolute bottom-0 left-0 p-6 w-full text-left'>
                  <h3 className='text-3xl font-bold text-brand-yellow drop-shadow-md transition-transform duration-300 group-hover:translate-x-1'>Johnny Kocur</h3>
                  <p className='mt-2 text-brand-gray-light max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-out delay-75'>Masterful vocal performances and acoustic storytelling with intricate fingerpicking for a night of pop-R&B. This is Johnny Kocur!</p>
                </div>
              </Link>
            </div>
          </div>
          <div className='motion-safe:animate-fadeIn' style={{ animationDelay: '0.7s' }}>
            <Link href='/shows/archive' className='group inline-flex items-center justify-center px-8 py-4 border border-brand-yellow text-lg font-medium rounded-md text-brand-yellow hover:bg-brand-yellow hover:text-brand-black shadow-lg transition-all duration-300 ease-out transform hover:scale-[1.03] focus:outline-none focus:ring-2 focus:ring-offset-brand-black focus:ring-brand-yellow'>
