      ...
      <section className='relative py-20 md:py-28 bg-brand-black z-[1] overflow-hidden'>
        ...
        <div className='container mx-auto px-4 text-center relative z-[1]'>
          ...
          <div className='relative flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-0 max-w-5xl mx-auto mb-16 min-h-[500px] md:min-h-[400px]'>
            ...
            >
              <Link
                href='/artist/deja-blue'
                className='block relative aspect-video lg:aspect-[4/3] rounded-lg overflow-hidden shadow-2xl transition-all duration-500 ease-out md:rotate-[-4deg] md:hover:rotate-0 md:hover:scale-105 md:hover:z-10 hover:shadow-[0_0_45px_rgba(var(--brand-yellow-rgb),0.3)]'
              >
                <Image
                ...
                <div className='absolute bottom-0 left-0 p-6 w-full text-left'>
                  ...
                  <p className='mt-2 text-brand-gray-light max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-out delay-75'>
                    Electrifying, soulful vocals, songwriting, and raw,
                    emotion-infused guitar and drums. This is Deja Blue!
                  </p>
                </div>
              </Link>
            </div>
            ...
            >
              <Link
                href='/rartist/johnny-kocur'
                className='block relative aspect-video lg:aspect-[4/3] rounded-lg overflow-hidden shadow-2xl transition-all duration-500 ease-out md:rotate-[3deg] md:hover:rotate-0 md:hover:scale-105 md:hover:z-10 hover:shadow-[0_0_45px_rgba(var(--brand-yellow-rgb),0.3)]'
              >
                <Image
                ...
                <div className='absolute bottom-0 left-0 p-6 w-full text-left'>
                  ...
                  <p className='mt-2 text-brand-gray-light max-w-sm transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-out delay-75'>
                    Masterful vocal performances and acoustic storytelling with
                    intricate fingerpicking for a night of pop-R&B. This is
                    Johnny Kocur!
                  </p>
                </div>
              </Link>
