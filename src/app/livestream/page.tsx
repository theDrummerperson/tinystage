...
export const metadata = {
  ...
  description: 'Learn how to access the TinyStage global livestream, powered by FEED Media. Watch intimate live performances from Erie, PA, anywhere in the world.',
};
      ...
      <section className="relative h-[60vh] min-h-[450px] md:h-[70vh] flex items-center justify-center text-center text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl text-brand-yellow font-semibold mt-4 motion-safe:animate-fadeIn" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center max-w-5xl mx-auto">
            ...
            <div className="text-lg text-brand-gray-light leading-relaxed space-y-4 motion-safe:animate-fadeIn" style={{ animationDelay: '0.4s' }}>
              ...
              <p>
                Every TinyStage performance is a unique event, happening live and in-person at the{' '}
                <a href="https://feed.art" target="_blank" rel="noopener noreferrer" className="font-bold text-brand-yellow hover:underline">
                  FEED Media Arts Center
                </a>{' '}
                in Downtown Erie.
              </p>
              <p>
                Through our partnership with FEED, we're proud to broadcast every show live, bringing the intimate energy of our stage to a global audience, for free.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-brand-black">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-white mb-4">How to Access the Livestream</h2>
          ...
          <ol className="space-y-8">
            {/* Step 1 */}
            <li className="flex items-start motion-safe:animate-fadeIn" style={{ animationDelay: '0.1s' }}>
              ...
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-1">Step 1: Create a Bandcamp Account</h3>
                <p className="text-brand-gray-light">If you don't already have one, sign up for a free fan account on Bandcamp. This is required to follow artists and get notifications.</p>
              </div>
            </li>

            {/* Step 2 */}
            <li className="flex items-start motion-safe:animate-fadeIn" style={{ animationDelay: '0.3s' }}>
              <div className="flex-shrink-0 flex flex-col items-center mr-6">
                <div className="w-12 h-12 bg-brand-gray-dark border-2 border-brand-yellow/50 rounded-full flex items-center justify-center">
              ...
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-1">Step 2: Follow FEED on Bandcamp</h3>
                <p className="text-brand-gray-light">Visit our partner's page and click the "Follow" button. This ensures you'll be notified the moment the livestream begins.</p>
              </div>
            </li>

            {/* Step 3 */}
            <li className="flex items-start motion-safe:animate-fadeIn" style={{ animationDelay: '0.5s' }}>
               <div className="flex-shrink-0 flex flex-col items-center mr-6">
                <div className="w-12 h-12 bg-brand-gray-dark border-2 border-brand-yellow/50 rounded-full flex items-center justify-center">
              ...
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-1">Step 3: Tune In on Show Night</h3>
                <p className="text-brand-gray-light">The livestream feed goes live at the same time as the performance. Check your email or Bandcamp feed for a direct link on the day of the show.</p>
              </div>
            </li>
          </ol>
