...
const supportOptions = [
  {
    ...
    icon: (
      <svg
        ...
        viewBox='0 0 24 24'
        fill='currentColor'
        className='w-10 h-10 lg:w-12 lg:h-12 mx-auto mb-5 text-brand-yellow group-hover:scale-110 transition-transform duration-300'
      >
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='space-y-5 md:space-y-6'>
            ...
            <p className='text-lg md:text-xl text-brand-gray-light/90 font-normal leading-relaxed tracking-wider max-w-3xl mx-auto'>
              Your support helps us shine a spotlight on incredible local
              artists and create memorable live music experiences. Here’s how
              you can contribute.
            </p>
          ...
          <div className='max-w-3xl mx-auto px-4'>
            ...
            <blockquote className='max-w-2xl mx-auto'>
              <p className='text-lg md:text-xl text-brand-gray-light/90 leading-relaxed italic mb-4'>
                "TinyStage isn't just a venue; it's a vital part of our local
                music scene. Supporting them means supporting the artists who
                pour their hearts out on that stage and the community that comes
                together to listen."
              </p>
            ...
            <p className='text-lg text-brand-gray-light/80 max-w-2xl mx-auto mt-8'>
              Join us in making a difference. Every bit of support helps us
              create more TinyStage magic.
            </p>
          </div>
        </section>
      </main>
