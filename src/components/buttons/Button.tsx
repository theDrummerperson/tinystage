...
export type ButtonVariant =
  ...
  | 'outline'
  | 'ghost'
  | 'link'; // ADDED 'ghost' and 'link'
export type ButtonSize = 'sm' | 'md' | 'lg' | 'xl';

// Extend native button props for flexibility
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  // Use ButtonHTMLAttributes for native button props
...
const variantClasses: Record<ButtonVariant, string> = {
  // KEYS MUST MATCH ButtonVariant
  primary:
    'bg-brand-yellow text-brand-black hover:bg-yellow-400 focus-visible:ring-brand-yellow disabled:opacity-60 disabled:cursor-not-allowed', // Example using brand colors
  secondary:
    'bg-brand-gray-dark text-brand-white hover:bg-brand-gray-medium border border-brand-gray-medium focus-visible:ring-brand-gray-medium disabled:opacity-60 disabled:cursor-not-allowed', // Example
  outline:
    'bg-transparent text-brand-yellow border border-brand-yellow hover:bg-brand-yellow/10 focus-visible:ring-brand-yellow disabled:opacity-60 disabled:cursor-not-allowed', // Example
  ghost:
    'bg-transparent text-brand-yellow hover:bg-brand-yellow/10 focus-visible:ring-brand-yellow disabled:opacity-60 disabled:cursor-not-allowed', // Example
