        ...
        <div className='bg-brand-gray-dark/30 backdrop-blur-md border border-brand-gray-dark/50 p-8 sm:p-12 md:p-16 rounded-2xl shadow-xl max-w-md w-full'>
          <div className='mb-6'>
            ...
            <svg
              ...
              className='h-16 w-16 sm:h-20 sm:w-20 text-brand-yellow mx-auto opacity-80'
              fill='none'
              viewBox='0 0 24 24'
              stroke='currentColor'
              strokeWidth={1.5}
          ...
          <p className='text-brand-gray-light/80 leading-relaxed mb-8 text-base sm:text-lg'>
            Our official TinyStage merchandise store is under construction.
            We're brewing up some awesome gear for you. Check back soon to grab
            your exclusive items and support local music!
          </p>
          <Link
            href='/'
